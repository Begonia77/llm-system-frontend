...
import { deleteWarehouse, exportWarehouse, getWarehousePage } from '@/api/system/warehouse'
...
async function handleExport() {
  createConfirm({
    ...
    async onOk() {
      await exportWarehouse(getForm().getFieldsValue())
...
<template>
  <div>
    ...
    <WarehouseModal @register="registerModal" @success="reload()" />
  </div>
</template>
