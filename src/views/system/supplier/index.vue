...
import { deleteSupplier, exportSupplier, getSupplierPage } from '@/api/system/supplier'
...
async function handleExport() {
  createConfirm({
    ...
    async onOk() {
      await exportSupplier(getForm().getFieldsValue())
...
<template>
  <div>
    ...
    <SupplierModal @register="registerModal" @success="reload()" />
  </div>
</template>
