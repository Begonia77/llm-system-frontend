...
import { columns, searchFormSchema } from './brand.data'
import { useI18n } from '@/hooks/web/useI18n'
import { useMessage } from '@/hooks/web/useMessage'
import { useModal } from '@/components/Modal'
import { IconEnum } from '@/enums/appEnum'
import { BasicTable, TableAction, useTable } from '@/components/Table'
import { deleteBrand, exportBrand, getBrandPage } from '@/api/system/brand'
...
async function handleExport() {
  createConfirm({
    ...
    async onOk() {
      await exportBrand(getForm().getFieldsValue())
...
<template>
  <div>
    ...
    <BrandModal @register="registerModal" @success="reload()" />
  </div>
</template>
